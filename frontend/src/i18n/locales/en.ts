export default {
  ...
  image: {
    ...
    // Image Edit
    navGenerate: 'Image Generation',
    navEdit: 'Image Edit',
    history: 'History',
    editMode: 'Region Edit',
    varyMode: 'Variations',
    uploadPrompt: 'Click or drag to upload image',
    uploadHint: 'Supports PNG, JPG, WEBP formats',
    varyHint: 'Upload image to generate variations',
    ...
    editPromptPlaceholder: 'Describe how you want to modify this area...',
    processing: 'Processing...',
    generateEdit: 'Generate Edit',
    results: 'Results',
    clearResults: 'Clear Results',
    changeImage: 'Change Image',
    varyStrong: 'Strong Variation',
